...
@test "sync: stop on hook post-install error bash" {
  fixture="./fixtures/sync/hook_error_post_install_bash"
  use_fixture "$fixture"
...
@test "sync: stop on hook post-install error zsh" {
  fixture="./fixtures/sync/hook_error_post_install_zsh"
  use_fixture "$fixture"
